...
var asistencias = 0;
var asistenciasMesActual = 0;

// Fechas
 var day = datetime.datetime.now().day;     // Hay un problema que se habla mas adelante, cuando el numero del dia es "muy alto"
 var month = datetime.datetime.now().month;
...
calculoDeportes = () => {
    ...
    months.forEach(element => {
        ...
        // Se suman los dias de los meses que quedan
            ...
            dias = dias + month[element];
        }
        
    var mesesSobrantes = length(months) - cont + 1;
